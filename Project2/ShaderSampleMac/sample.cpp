...
Display( )
{
	...
	//NowT0 = 0.5f;
	//NowD  = 0.25f;
	Pattern.SetUniformVariable( "uAd", Ad.GetValue( Time ) );
	Pattern.SetUniformVariable( "uBd", Bd.GetValue( Time ) );
	Pattern.SetUniformVariable( "uNoiseAmp", NoiseAmp.GetValue( Time ) );
	Pattern.SetUniformVariable( "uNoiseFreq", NoiseFreq.GetValue( Time ) );
	Pattern.SetUniformVariable( "uTol", Tol.GetValue( Time ) );
...
InitGraphics( )
{
	...
	Ad.Init( );
    Ad.AddTimeValue(  0.0,  0.087 );
    Ad.AddTimeValue(  2.0,  0.141 );
    Ad.AddTimeValue(  5.0,  0.217 );
    Ad.AddTimeValue(  8.0,  0.141 );
    Ad.AddTimeValue( 10.0,  0.087 );

	Bd.Init( );
    Bd.AddTimeValue(  0.0,  0.033 );
    Bd.AddTimeValue(  2.0,  0.098 );
    Bd.AddTimeValue(  5.0,  0.218 );
    Bd.AddTimeValue(  8.0,  0.098 );
    Bd.AddTimeValue( 10.0,  0.033 );

	NoiseAmp.Init( );
    NoiseAmp.AddTimeValue(  0.0,  0.117 );
    NoiseAmp.AddTimeValue(  2.0,  0.312 );
    NoiseAmp.AddTimeValue(  5.0,  0.589 );
    NoiseAmp.AddTimeValue(  8.0,  0.732 );
    NoiseAmp.AddTimeValue( 10.0,  0.951 );

	NoiseFreq.Init( );
    NoiseFreq.AddTimeValue(  0.0,  0.153 );
    NoiseFreq.AddTimeValue(  2.0,  0.388 );
    NoiseFreq.AddTimeValue(  5.0,  0.712 );
    NoiseFreq.AddTimeValue(  8.0,  0.814 );
    NoiseFreq.AddTimeValue( 10.0,  0.976 );

	Tol.Init( );
    Tol.AddTimeValue(  0.0,  0.147 );
    Tol.AddTimeValue(  2.0,  0.358 );
    Tol.AddTimeValue(  5.0,  0.789 );
    Tol.AddTimeValue(  8.0,  0.358 );
    Tol.AddTimeValue( 10.0,  0.147 );
