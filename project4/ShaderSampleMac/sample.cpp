...
Display( )
{
	...
	Pattern.SetUniformVariable( "uNoiseAmp", NoiseAmp.GetValue( Time ) );
	Pattern.SetUniformVariable( "uNoiseFreq", NoiseFreq.GetValue( Time ) );
	...
	Pattern.SetUniformVariable( "uMix", Mix.GetValue( Time ) );
...
InitGraphics( )
{
	...
	Ua.Init( );
    Ua.AddTimeValue(  0.0,  0.087 );
    Ua.AddTimeValue(  2.0,  0.141 );
    Ua.AddTimeValue(  5.0,  0.358 );
    Ua.AddTimeValue(  8.0,  0.598 );
    Ua.AddTimeValue( 10.0,  0.812 );

	Ub.Init( );
    Ub.AddTimeValue(  0.0,  0.082 );
    Ub.AddTimeValue(  2.0,  0.35 );
    Ub.AddTimeValue(  5.0,  0.812 );
    Ub.AddTimeValue(  8.0,  1.798 );
    Ub.AddTimeValue( 10.0,  3.0);

	Uc.Init( );
    Uc.AddTimeValue(  0.0,  0.147 );
    Uc.AddTimeValue(  2.0,  0.358 );
    Uc.AddTimeValue(  5.0,  0.789 );
    Uc.AddTimeValue(  8.0,  1.358 );
    Uc.AddTimeValue( 10.0,  4.147 );

	Ud.Init( );
    Ud.AddTimeValue(  0.0,  0.147 );
    Ud.AddTimeValue(  2.0,  0.358 );
    Ud.AddTimeValue(  5.0,  0.789 );
    Ud.AddTimeValue(  8.0,  1.358 );
    Ud.AddTimeValue( 10.0,  2.147 );
	
	NoiseAmp.Init( );
    NoiseAmp.AddTimeValue(  0.0,  0.117 );
    NoiseAmp.AddTimeValue(  2.0,  0.812 );
    NoiseAmp.AddTimeValue(  5.0,  1.589 );
    NoiseAmp.AddTimeValue(  8.0,  2.732 );
    NoiseAmp.AddTimeValue( 10.0,  3.951 );

	NoiseFreq.Init( );
    NoiseFreq.AddTimeValue(  0.0,  0.153 );
    NoiseFreq.AddTimeValue(  2.0,  1.388 );
    NoiseFreq.AddTimeValue(  5.0,  3.712 );
    NoiseFreq.AddTimeValue(  8.0,  6.814 );
    NoiseFreq.AddTimeValue( 10.0,  15.976 );
	
	Mix.Init( );
    Mix.AddTimeValue(  0.0,  0.082 );
    Mix.AddTimeValue(  2.0,  0.35 );
    Mix.AddTimeValue(  5.0,  0.512 );
    Mix.AddTimeValue(  8.0,  0.798 );
    Mix.AddTimeValue( 10.0,  1.0);
